...
| Hazard workflow pieces | Practice wrappers and named Visual/Nonvisual Hazard Simulation variants exist; Simulation input and response pieces are explicit | Reconcile required Review variants and exact review context, remaining family source/navigation pieces and neutral-input reuse. |
