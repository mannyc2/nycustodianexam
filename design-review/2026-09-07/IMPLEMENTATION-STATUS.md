...
| Exams / Settings / Offline / report | UTILITY-PAGES-REVIEW.md: first-visit desktop/compact captures, Settings action layout/Offline grouping and recovery checks | Delete preview cancellation/captures verified; returning summaries, live export counts, Offline installed summary, Exams record and report comparison remain; actual Offline active/removal/unavailable states captured |
