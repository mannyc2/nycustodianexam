...
| Exams / Settings / Offline / report | UTILITY-PAGES-REVIEW.md: first-visit desktop/compact captures, Settings action layout/Offline grouping and recovery checks | Returning summaries, dialogs, Offline states, Exams record and report comparison remain |
