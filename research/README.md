...
|---|---|---|
| [`exam-refresh-2026-09-10.md`](exam-refresh-2026-09-10.md) | Completed bounded official-source refresh | Retains live-index inspection, retrieval hashes, negative-search limits, and an unresolved historical index-label inconsistency; accepted status lives in `docs/FACTBASE.md` and the authored Nassau fact sheet. |
