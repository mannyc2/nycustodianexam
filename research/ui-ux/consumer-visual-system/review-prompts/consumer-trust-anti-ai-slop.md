# Plan 006 isolated Codex review: consumer trust and anti-AI-slop quality
...
1. unofficial-and-source-trust — the independent/unofficial boundary and source support are evident without overwhelming the study task.
2. non-institutional-impersonation — visual authority does not mimic an agency, school, credential, or official exam product.
3. specificity-and-originality — the territory feels specific to this product and accepted content rather than a generic template.
4. anti-ai-slop-quality — imagery, hierarchy, copy treatment, and surfaces avoid generic AI gloss, filler, and synthetic inconsistency.
5. consumer-confidence-hierarchy — primary study actions, context, warnings, and recovery cues create a credible next-step hierarchy.
