# Plan 006 isolated Codex review: accessibility and cognitive load
...
1. semantic-and-focus-clarity — heading/landmark structure, action order, keyboard traversal, and visible focus remain understandable.
2. zoom-reflow-and-large-text — 320 CSS-pixel reflow, 400%-equivalent zoom, and 125% root text preserve access and hierarchy.
3. contrast-and-non-color-meaning — information and state remain perceivable without relying on color alone, including forced colors.
4. cognitive-chunking — density, grouping, labels, and progressive disclosure reduce avoidable scan and memory load.
5. motion-state-and-recovery — reduced motion, offline/empty/error states, and recovery actions remain calm and comprehensible.
