...
export const Fact = { Root: FactRoot, Label: FactLabel, Value: FactValue, Status: FactStatus, Source: SourceLineCitations, VerifiedAt: FactVerifiedAt, ProfileVersion: FactProfileVersion } as const
