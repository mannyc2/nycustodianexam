...
export const renderAnnouncementMilestones = (
  ...
  if (sectionId === "exams-cycle") {
    ...
    return `<section class="home-section announcement-cycle exams-cycle-summary" id="exams-cycle" aria-labelledby="exams-cycle-heading">
      ...
      <div class="notice notice-neutral"><h3>Check results or the next exam</h3><p><a href="https://www.nassaucivilservice.com/NCCSWeb/homepage.nsf/WebSiteContent/Eligible%2BLists%2BBy%2BTitle?OpenDocument">Check Nassau’s current eligible lists</a>. Match the exam number on your application: 60112026 for open competitive or 61012026 for promotion.</p><p>For future openings, <a href="https://www.governmentjobs.com/careers/nassaucountyny/classspecs">find Custodian in Job Descriptions and Job Interest Cards</a> to request open-competitive exam notifications. Check <a href="https://www.governmentjobs.com/careers/nassaucountyny/promotionaljobs">promotion announcements</a> separately.</p><p>For individual updates, check your applicant account and email, including spam. <a href="https://www.nassaucivilservice.com/NCCSWeb/homepage.nsf/HomePage?ReadForm">Contact Nassau Civil Service</a> with exam or eligible-list questions.</p></div>
      <details class="home-cycle-evidence"><summary>Sources and review dates</summary>${sourceProofLine(lineIds, evidence.map((fact) => fact.reviewedOn), sourceLineById, sourceById)}${sourceLineLinks(lineIds, sourceLineById, sourceById)}</details>
    </section>`
  }
...
const buildPages = ({
  ...
  <main class="page-shell home-page exams-page" id="main-content" tabindex="-1">
    ...
    <div class="home-content">
      ...
      <section class="home-section" id="exams-board" data-exam-browser aria-labelledby="exam-board-heading"><div class="section-header"><h2 id="exam-board-heading">Find your exam</h2><p>Open an entry to compare its facts. Your official announcement and admission notice govern your exam.</p></div>
        <details class="exam-filter-disclosure" data-exam-filter-disclosure open hidden><summary>Search and filter</summary><div class="exam-search-controls"><div class="search-field" data-exam-search-field hidden><label class="sr-only" for="exam-search">Search announcements and study plans</label>${navIcon("search")}<input id="exam-search" type="search" data-exam-search placeholder="Title, jurisdiction, or exam number" autocomplete="off"></div>
  ...
  pages.push({
    ...
    body: `
  <main class="page-shell" id="main-content" tabindex="-1">
    <section class="page-header"><h1>Tool atlas</h1><p>Recognize a tool by its shape, use, and the features that tell look-alikes apart. Every published illustration has a written description and source support.</p></section>
