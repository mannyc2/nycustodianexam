...
const buildPages = ({
  ...
  <main class="page-shell home-page" id="main-content" tabindex="-1">
    ...
    <div class="home-content">
      <section class="home-section" aria-labelledby="home-areas"><div class="section-header"><h2 id="home-areas">What the test covers</h2><p>Three areas, named by the state test guide for this series. Your own announcement controls which subjects apply; practice-set sizes are designed for this site.</p></div>${scopeList}${subjectPlanFact === undefined ? "" : `${sourceProofLine(subjectPlanFact.sourceLineIds, [subjectPlanFact.reviewedOn], sourceLineById, sourceById)}<details class="technical-details"><summary>Technical details</summary>${sourceLineLinks(subjectPlanFact.sourceLineIds, sourceLineById, sourceById)}</details>`}</section>
