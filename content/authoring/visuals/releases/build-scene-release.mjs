...
const accessibilityZones = {
  ...
  3: {
    neutral: ["upper flight", "central landing", "lower flight", "wall fixtures"],
    targets: ["central landing"],
    decoys: ["wall fixtures"],
    safeBackground: ["upper and lower flights", "lower level", "ceiling"],
  },
  4: {
    neutral: ["left court storage", "rear doors and equipment", "central court", "right wall storage"],
  ...
  5: {
    ...
    decoys: ["upper and lower shelving"],
    safeBackground: ["upper wall", "service sink", "lower floor"],
  },
  6: {
    neutral: ["upper bottle shelf", "center bowl-and-utensil shelf", "lower bowl shelf", "separate pan rack"],
    targets: ["upper and center shelves"],
    decoys: ["separate pan rack"],
    safeBackground: ["both shelving units", "rear tiled wall", "lower floor"],
  },
  7: {
  ...
  8: {
    neutral: ["teacher desk", "student desks", "right wall equipment", "central aisle"],
  ...
  9: {
    ...
    safeBackground: ["stall", "waste-bin side", "central floor outside the objects"],
  },
  10: {
    neutral: ["building and planting edge", "central walkway", "lower-left objects", "right-side collection pad"],
  ...
  11: {
    neutral: ["loading door", "left dolly and boxes", "center pallet and boxes", "right wall storage"],
    targets: ["left dolly and boxes"],
    decoys: ["center pallet and boxes"],
    safeBackground: ["loading door", "right wall storage", "lower floor"],
  },
  12: {
    neutral: ["serving counter", "left dining tables", "center person and boxes", "right wall cart"],
  ...
  13: {
    ...
    decoys: ["right tool holder"],
    safeBackground: ["lower floor", "right cleaning cart", "sink"],
  },
  14: {
    neutral: ["left dining area", "central table and mop", "right janitor cart", "rear serving area"],
    targets: ["central table and mop"],
    decoys: ["right janitor cart cabinet"],
    safeBackground: ["left and rear dining area", "right janitor cart", "lower floor"],
  },
  15: {
    neutral: ["left wall fan", "central court", "rear wall fan", "rear bleachers"],
    targets: ["left wall fan"],
    decoys: ["rear wall fan"],
    safeBackground: ["central court", "rear bleachers", "wall padding"],
  },
  16: {
    neutral: ["left wall tool storage", "left workbench", "center-right saw", "lower area"],
    targets: ["center-right saw"],
    decoys: ["left wall tool storage"],
    safeBackground: ["left and center workbench", "right workbench plug", "lower area"],
  },
  17: {
    neutral: ["teacher wall", "student desks", "right-side ladder", "wall-side cord and fan"],
    targets: [],
    decoys: ["right-side ladder", "wall-side cord", "wall-side fan"],
    safeBackground: ["student desks", "central aisle", "teacher wall"],
  },
  18: {
    neutral: ["left sink and cabinet", "center bottle shelf", "center-right tool rack", "right doorway and wall hook"],
    targets: [],
    decoys: ["center bottle shelf", "center-right tool rack", "right wall hook"],
    safeBackground: ["left sink", "lower floor", "right doorway", "left cabinet"],
  },
};
